...
const CustDetails = () =>{
    ...
    //alert(CustEmail);
    useEffect (()=>{
      const email=sessionStorage.getItem("CustEmail");
    ...
    return (
        ...
        <div className='column'>
                ...
                <input type='text' className='email' id='email' name='email' placeholder='Email' required="required" value={data.email}/>
        ...
        <label className='lname'>Last Name</label>
                ...
                <input type='text' className='age' id='age' name='age' placeholder='Age' required="required" value={data.age}/>
